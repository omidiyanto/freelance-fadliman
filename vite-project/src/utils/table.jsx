            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex justify-between items-center relative w-full px-2 max-w-full flex-grow flex-1">
                        ...
                        <a href="/tambahbarang" className="font-semibold text-base text-white bg-green-700 p-2 rounded-xl">+ Tambah Barang</a>
                    </div>
                </div>
                            ...
                            {data && data.data.allData.map((value, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td className="border-t-0 px-6 text-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-black">
                                            {value.tanggal_pembelian.split("T")[0]}
                                        </td>
                                        ...
                                        <td className="flex justify-center gap-[10px] border-t-0 px-6 text-center text-xs whitespace-nowrap p-4 text-black">
                                            <a href={`/edit/${value.id}`} className="border p-2 rounded-xl bg-cyan-800 text-white p-2 rounded-xl">Update</a>
